...
export default function Page() {
  ...
  return (
    <div className="bg-black ">
      ...
      {isLoaded && (
        <div className="fixed select-none bottom-0 w-screen  flex justify-center ">
          {items.map((o) => (
            <img
              key={o.url}
              onClick={o.fn}
              role={"button"}
              className={clsx("w-20 h-20 mx-4  bg-opacity-10 p-4", {
                // @ts-ignore
      ...
      {isLoaded && (
        <div className="fixed select-none z-50 right-0 h-screen w-96 text-white top-0 pt-4  bg-black bg-opacity-20">
