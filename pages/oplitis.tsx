...
`,
  ...
  armor: {
    ...
    desc_en:
      "They are the main parts of the protection of the hoplite's body. They are a product of evolution from the old full body armor during the 7th and 6th century, where pieces of metal, mainly brass were applied to the warrior's trunk, making it cumbersome. At the beginning of the 5th century they were replaced by fabric or leather breastplates that have metal parts or multiple layers of the corresponding material, but retaining the metal leggings, usually made of brass. In this way the hoplite acquires agility and the phalanx is able to perform complex maneuvers.",
  },
  helmet: {
    title_el: "Κράνος",
    title_en: "Helmet",
    ...
    desc_en:
      "The protection of the hoplite was completed by the helmet on his head. Since the hoplite was fighting hand to hand, the helmet should not be so heavy that it impedes his sight or hearing. Therefore, the protection it offered him was not so complete, a concession to his flexibility during battle. However, it did not cease to be uncomfortable, which is why on several occasions the hoplite wore a leather hat inside before putting on his helmet. In most cases during the 5th century it was enclosed protecting the face up to the lower cheeks. This is the type of helmet known as Corinthian. A plume of horsehair in various sizes and colors was usually fitted to the helmet. Initially, the aim was to make the hoplite look taller and more imposing, but gradually the different plumes declared the ranks in the lineup.",
  },
  spear: {
    title_el: "Δόρυ",
    title_en: "Spear",
    ...
    desc_en:
      "The ultimate offensive weapon. It is a wooden stem with a length that varies from 2.2 to 2.7 meters. It was usually made from the Fraxos tree (also known as Melia) in order to be light but durable. A metal spike was fitted in front, while at the bottom there was an even smaller one, called a sweeper. The opponent, in addition to the wall of shields, had to face the spears which protruded in front of the shields across the front and in the back of the line. Even when a spear broke on impact, its wielder could use its sweeper-bearing lower part as a spare point. In case the spear remained intact, a sweeper served as a counterweight to keep the spear weighted. In the event that the division of the opposing formation was achieved, during the advance of the victorious hoplites the sweeper gave the finishing blow to the fallen opponents.",
  },
  sword: {
    title_el: "Ξίφος",
    title_en: "Sword",
    ...
    desc_en:
      "As an auxiliary weapon, the hoplite also carried a sword. This term referred to a straight double-edged blade with a handle usually of brass. However, during the 5th century and with the contact of the hoplite with the armies of the East, curved blades began to appear, which widened towards the tip, such as cutter and the knife, so that the blows during hand-to-hand combat acquire greater elasticity.",
  },
};

export default function Page() {
  const { unityProvider, sendMessage, isLoaded, loadingProgression, unload } =
    useUnityContext({
