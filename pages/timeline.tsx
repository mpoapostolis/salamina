...
const timeLine = [
  ...
  },
  {
    ...
    desc: "Άνοιξη: Άφιξη του περσικού στόλου στο Αιγαίο πέλαγος υπό τους Δάτη και Αρταφέρνη. Την εκστρατεία συνοδεύει και ο εξόριστος τύραννος των Αθηνών Ιππίας. Ο βασιλέας της Σπάρτης Κλεομένης επεμβαίνει μετά από αίτημα της Αθήνας στην Αίγινα και αποτρέπει την υποταγή της στους Πέρσες.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
  ...
  },
  {
    ...
    desc: "Φθινόπωρο: Ο περσικός στόλος αποσύρεται από το Αιγαίο.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
  ...
  },
  {
    ...
    desc: "Άνοιξη: Επίσημη δημιουργία μιας πανελλήνιας συμμαχίας με κέντρο το Ιερό του Ισθμού στην Κόρινθο. Ο περσικός στρατός βρίσκεται στον Ελλήσποντο.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Ιούνιος: Ο Ξέρξης περνά τον Ελλήσποντο και μέσω Θράκης και Μακεδονίας βαδίζει προς την κυρίως Ελλάδα. Οι ελληνικές πόλεις συνεδριάζουν στον Ισθμό και κηρύσσουν ειρήνη μεταξύ τους και επιστροφή των εξόριστων.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
  ...
  },
  {
    ...
    desc: "Σεπτέμβριος: Ο Ξέρξης εισέρχεται στην Αθήνα η οποία πυρπολείται σε αντίποινα για την πυρπόληση των Σάρδεων. Λαμβάνει χώρα η ναυμαχία στη Σαλαμίνα. Η καταστροφή του περσικού ναυτικού αλλάζει τα δεδομένα της εκστρατείας.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Οκτώβριος: Ο περσικός στόλος αναδιπλώνεται στη Μικρά Ασία ενώ ο Ξέρξης επιστρέφει στην Ανατολή. Ο περσικός στρατός όμως αποσύρεται για τον χειμώνα στη Θεσσαλία με επικεφαλής τον Μαρδόνιο, γαμπρό του Ξέρξη.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Άνοιξη: Ο ελληνικός στόλος συγκεντρώνεται στην Αίγινα και πλέει προς τη Δήλο.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Ιούνιος: Ο Μαρδόνιος εισβάλλει στη Βοιωτία, την οποία μετατρέπει σε στρατηγείο του. Η Αθήνα για μία ακόμα φορά εγκαταλείπεται, καταλαμβάνεται και καταστρέφεται. Ο ελληνικός στρατός αρχίζει να συγκεντρώνεται στη Βοιωτία.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Ιούλιος-Αύγουστος: Ο ελληνικός στόλος απελευθερώνει τη Χίο τη Σάμο και τη Λέσβο.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Σεπτέμβριος: Νίκη των Ελλήνων στις Πλαταιές εναντίον του Μαρδόνιου. Αυτός χάνει τη ζωή του, ενώ τα υπολείμματα του στρατού του υποχωρούν άτακτα προς τον Ελλήσποντο. Στη Μικρά Ασία ο ελληνικός στόλος κατανικά ένα μέρος του περσικού στόλου οχυρωμένου στο ακρωτήριο της Μυκάλης.",
    img: "transparent.png",
    Μέγεθος: "",
  },
  {
    ...
    desc: "Φθινόπωρο: Παρά το ότι η Σπάρτη αποχωρεί από τη διοίκηση του ενωμένου ελληνικού στόλου, οι Αθηναίοι παραμένουν εν δράσει και προχωρούν προς τον Ελλήσποντο. Στη διαδρομή πολιορκούν και καταλαμβάνουν τη Σηστό. Οι Πέρσες έχουν εκδιωχτεί οριστικά από τον κυρίως ελλαδικό χώρο.",
    img: "transparent.png",
    Μέγεθος: "",
  },
];
